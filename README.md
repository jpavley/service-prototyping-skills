...
| `templates/TODO.md`             | Planned work, grouped by heading. Synced by `/sp-done`.                          |
| `templates/DONE.md`             | Completed work, mirrors `TODO.md` headings. Synced by `/sp-done`.                |
...
- `sp-done.md` writes to `TODO.md`, `DONE.md`, `DECISIONS.md`, `DEFERRED.md` at session end.
